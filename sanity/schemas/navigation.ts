      ...
      of: [
        {
          ...
          fields: [
            ...
            defineField({
              name: 'hasDropdown',
              title: 'Dropdown-Untermenü aktivieren',
              type: 'boolean',
              description: 'Aktiviert ein Flyout-Dropdown mit Unterlinks',
              initialValue: false,
            }),
            defineField({
              name: 'dropdownItems',
              title: 'Dropdown-Einträge',
              type: 'array',
              description: 'Links im Dropdown-Menü (nur aktiv wenn Dropdown aktiviert)',
              hidden: ({ parent }) => !parent?.hasDropdown,
              of: [
                {
                  type: 'object',
                  name: 'dropdownItem',
                  title: 'Dropdown-Eintrag',
                  ...
                  fields: [
                    ...
                    defineField({
                      ...
                      title: 'Link',
                      type: 'string',
                      description: 'z.B. "/ratten" oder "/schaedlinge"',
                      validation: (Rule) => Rule.required(),
                    }),
                    defineField({
                      name: 'description',
                      ...
                      type: 'string',
                      description: 'Kleine Erklärung unter dem Link im Dropdown',
                    }),
                  ],
                },
              ],
